          ...
          <Card className="bg-gradient-to-br from-zinc-900 to-zinc-950 border border-zinc-800 shadow-xl">
            <CardContent className="p-6 sm:p-8">
              ...
              <div className="space-y-6">
                {/* Creator Card - Always at top on mobile, side on desktop */}
                <div className="flex flex-col sm:flex-row gap-6 items-start">
                  {/* Description - Now first on mobile */}
                  <div className="flex-1 space-y-4 text-zinc-300 order-1">
                    <p>
                  ...
                  {/* Creator Card - Now second on mobile */}
                  <motion.div
                    className="bg-zinc-800/30 rounded-lg p-4 border border-zinc-700 w-full sm:w-auto sm:flex-shrink-0 order-2 sm:order-2"
                    whileHover={{ scale: 1.02 }}
                  >
                    <div className="flex sm:flex-col items-center sm:text-center gap-4 sm:gap-0">
                      <motion.div
                        className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-teal-500 to-emerald-600 rounded-full flex items-center justify-center flex-shrink-0 sm:mx-auto sm:mb-3"
                        whileHover={{ rotate: 5 }}
                      >
                        <span className="text-xl sm:text-2xl font-bold text-white">AT</span>
                      </motion.div>
                      <div className="flex-1 sm:flex-initial">
                        <h3 className="font-semibold text-zinc-200 mb-1">Alok Tripathi</h3>
                        <p className="text-sm text-zinc-400 mb-1 sm:mb-2">IITM BS Diploma Student</p>
